...
- In your *Podfile* write the following
  ...
  ```
  use_frameworks!
  pod 'MasterpassQRCoreSDK', '~> 1.0.4-beta2'
  ```
...
[2]: https://www.github.com/Mastercard/masterpass-qr-core-sdk-ios/releases/download/1.0.4-beta2/masterpassqrcoresdk-framework-ios.zip
